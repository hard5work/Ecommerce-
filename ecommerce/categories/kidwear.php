...
if(isset($_POST['name'],$_POST['price']))//for variables. doesnot give error even in null
 ...
 $name = $_POST['name'];
 $price = $_POST['price'];
 $query1 = "SELECT * FROM kid_wear WHERE image = '$target_file'"; //check if images already existed or not
...
{
 $query = "INSERT INTO kid_wear(name,image,price) VALUES ('$name' , '$target_file', '$price')";
